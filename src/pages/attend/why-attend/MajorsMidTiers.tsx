  ...
  return (
    <div className="bg-white text-gray-800">
      ...
      <div className="relative h-60 bg-gradient-to-r from-[#64a63a] to-[#d4ed31] flex items-center justify-center">
        <h1 className="text-white text-4xl font-bold">Mining Indaba for Majors & Mid-tiers</h1>
      </div>

      {/* Connect with Investors Section */}
      <section className="container mx-auto px-4 py-16 text-center max-w-4xl">
        <h2 className="text-4xl font-bold mb-6">Connect with Key Players at Mining Indaba 2026: Opportunities for Majors & Mid-tiers</h2>
        <p className="text-lg mb-8">
          ...
          majors and mid-tiers mining companies to form connections, discuss project progression and explore financing opportunities. Additional value lies in
      ...
      {/* Top reasons why Majors & Mid-tiers Attend Mining Indaba Section */}
      <section className="container mx-auto px-4 py-16 text-center">
        <h2 className="text-4xl font-bold mb-12">Top reasons why Majors & Mid-tiers Attend Mining Indaba</h2>
        ...
        <p className="text-xl mt-12 mb-8">
          ...
          <br />
          Mining Indaba is where majors and mid-tiers come to get deals moving. Whether you're looking to <span className="font-bold">raise capital</span>, <span className="font-bold">attract new investors</span>, or explore
