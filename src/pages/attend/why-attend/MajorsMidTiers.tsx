...
const MajorsMidTiers = () => {
  ...
  return (
    <div className="bg-white text-gray-800">
      {/* Hero Section */}
      <div className="relative h-60 bg-gradient-to-r from-[#2563eb] to-[#60a5fa] flex items-center justify-center">
      ...
      <section className="container text-center border-2 rounded-md mx-auto p-5 my-12 mx-10 max-w-6xl shadow-lg">
        <h2 className="text-4xl font-bold mb-6">
          Showcase your brand to 10,000+ attendees at Mining Indaba: a must for
          mining companies in Africa
        </h2>
        <p className="text-lg mb-8">
          Mining Indaba enables direct engagement with African ministers, senior
          government officials, and industry leaders, providing a unique
          opportunity to discuss policy issues, regulatory changes, and legal
          frameworks impacting the mining sector. With exclusive access to the
          Investment Lounge, mining companies in Africa will also benefit from
          exciting networking opportunities. This event further provides a
          platform to deliver key messaging that enhances awareness and external
          perception, driving increased share value.
        </p>
        <button className="bg-[#2563eb] hover:bg-[#1e40af] text-sm text-white font-bold px-8 py-3 rounded text-lg shadow-md uppercase tracking-wide transition-colors">
          REGISTER INTEREST
        </button>
      </section>
              ...
              <div className="bg-[#f8faf7] rounded-lg shadow-md h-full flex flex-col">
                ...
                <div className="px-4 py-10">
                  ...
                  <p className="text-gray-600 leading-relaxed text-sm">
                    In 2025, Mining Indaba hosted over 58 Ministers and 1400+
                    government officials. The Indaba provides a unique
                    opportunity to engage with government officials, regulators,
                    and policymakers to discuss key policy issues, regulatory
            ...
            <div className="w-full md:w-1/4 px-4 mb-8">
              <div className="bg-[#f8faf7] rounded-lg shadow-md h-full flex flex-col">
                ...
                <div className="px-4 py-10">
                  ...
                  <p className="text-gray-600 leading-relaxed text-sm">
                    The exhibition hall houses a vast number of service
                    providers showcasing cutting-edge technologies, equipment,
                    and services, aiming to provide an overview of how their
                    services can enhance efficiency, productivity, safety, and
                    sustainability of developing and operating mines.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="w-full md:w-1/4 px-4 mb-8">
              <div className="bg-[#f8faf7] rounded-lg shadow-md h-full flex flex-col">
                ...
                <div className="px-4 py-10">
                  ...
                  <p className="text-gray-600 leading-relaxed text-sm">
                    Gain valuable intelligence and best practices from top
                    mining executives, government officials, and industry
                    leaders sharing their perspectives, strategies, and insights
                    through thought-provoking panels, presentations and
                    showcases.
                  </p>
                </div>
              </div>
            ...
            <div className="w-full md:w-1/4 px-4 mb-8">
              <div className="bg-[#f8faf7] rounded-lg shadow-md h-full flex flex-col">
                ...
                <div className="px-4 py-10">
                  ...
                  <p className="text-gray-600 leading-relaxed text-sm">
                    Mining Indaba gathers a diverse array of global industry
                    leaders from mining companies, national & international
                    governments, and industry professionals for 4 days in Cape
                    Town, hosting several dedicated networking receptions
                    providing an unparalleled access for investors to network,
                    forge new connections, and build fruitful relationships with
                    key stakeholders.
                  </p>
                </div>
              </div>
      ...
      <div className="py-12 text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-center text-4xl font-bold text-gray-800 mb-12">
            Major and Mid-tier Mining Companies who attended in the past
          </h2>
          ...
          <div className="flex flex-wrap -mx-4">
            ...
            <div className="w-full md:w-1/2 px-4 mb-8">
              <div className="bg-[#f8faf7] rounded-lg shadow-md h-full flex flex-col">
                ...
                <div className="px-14 py-10">
                  <h3 className="text-2xl font-semibold text-gray-800 mb-2 pb-6">
                    What makes this an ideal platform is the diversity of
                    thought and interaction. We all share the same challenges,
                    and we can find common solutions. If we collaborate and work
                    together, we can come to solutions but if we are not present
                    nobody knows what we can do.
                  </h3>
                  <p className="text-gray-600 leading-relaxed text-sm">
                    <span className="font-bold">Kavita Pema</span>
                    <br /> VP of Sustainability
                    <br />
                    AECI
                  </p>
                </div>
            ...
            <div className="w-full md:w-1/2 px-4 mb-8">
              <div className="bg-[#f8faf7] rounded-lg shadow-md h-full flex flex-col">
                ...
                <div className="px-14 py-10">
                  <h3 className="text-2xl font-semibold text-gray-800 mb-2 pb-6">
                    "What impressed me most was the energy, enthusiasm, and
                    sense that we were really about to go into the next cycle
                    and that Africa could take that and grow for itself."
                  </h3>
                  <p className="text-gray-600 leading-relaxed text-sm">
                    <span className="font-bold">Catherine Raw</span>
                    <br />
      ...
      <section className="container mr-18 px-4 py-16 text-center">
          ...
          <div className="text-left max-w-md w-3/5">
            <ul className="space-y-4 text-lg">
              <li className="flex items-center gap-3">
                <span className="w-5 h-5 bg-black"></span> Network & Make New
                Contacts
              </li>
              <li className="flex items-center gap-3">
                <span className="w-5 h-5 bg-[#2563eb]"></span> Attend Content
                Sessions
              </li>
              <li className="flex items-center gap-3">
                <span className="w-5 h-5 bg-[#2563eb]"></span> Meet Existing
                Supliers
              </li>
              <li className="flex items-center gap-3">
                <span className="w-5 h-5 bg-[#a0a0a0]"></span> Meet Existing
                Client
              </li>
            </ul>
          </div>
        ...
        <p className="text-xl mt-12 mb-8 text-start mx-12">
          ...
          <br />
          Mid-tier miners attend Mining Indaba to{" "}
          <span className="font-bold">
            build new contacts, connect with existing clients and suppliers
          </span>
          , and gain insights from the most pressing conversations. Whether you
          want to scale, optimise, or solidify your presence, Mining Indaba
          offers the right environment to engage, learn, and lead.
        </p>
      </section>
      ...
      <section className="container mr-18 px-4 py-16 text-center">
        ...
        <p className="text-xl mt-12 mb-8 text-start mx-12">
          ...
          <br />
          For major mining companies, Mining Indaba is more than an event—it's a
          platform to{" "}
          <span className="font-bold">amplify brand visibility</span>, engage
          with key stakeholders, and stay ahead of industry trends. With
          unparalleled networking, rich content, and an influential audience,
          this is where majors show up to make an impact and drive the agenda.
        </p>
        <div className="flex flex-col lg:flex-row items-center justify-center gap-2">
          <div className="flex-shrink-0 w-2/5">
          ...
          <div className="text-left max-w-md w-3/5">
            <ul className="space-y-4 text-lg">
              ...
              <li className="flex items-center gap-3">
                <span className="w-5 h-5 bg-[#2563eb]"></span> Attendt
                Contestant Sessions
              </li>
              <li className="flex items-center gap-3">
                <span className="w-5 h-5 bg-[#2563eb]"></span> Build Brand
                Awareness
              </li>
            </ul>
          </div>
        ...
        <div className="mt-16">
          <button className="bg-[#2563eb] rounded-sm text-sm text-white py-3 px-8 hover:bg-[#1e40af]">
            VIEW AGENDA
          </button>
        </div>
      </section>
