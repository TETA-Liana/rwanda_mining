    ...
    <div className="bg-white text-gray-800">
      ...
      <div className="relative h-60 bg-gradient-to-r from-[#64a63a] to-[#d4ed31] flex items-center justify-center">
        <h1 className="text-white text-4xl font-bold mt-16">
          Mining Indaba for Junior Miners
        </h1>
      </div>
      ...
      <section className="container text-center border-2 rounded-md mx-auto p-5 my-12 mx-10 max-w-6xl shadow-lg">
        <h2 className="text-4xl font-bold mb-6">
          Connect with Investors at Mining Indaba 2026: Opportunities for Junior
          Mining Companies
        </h2>
        <p className="text-lg mb-8">
          Mining Indaba is the ultimate networking, deal-making, and discussion
          forum for the industry's current trends and challenges. This event
          offers unparalleled opportunities for junior mining companies and
          exploration mining companies to form connections, discuss project
          progression and explore financing opportunities. Additional value lies
          in gaining valuable insights into market trends, new technologies, and
              ...
              <div className="bg-[#f8faf7] rounded-lg shadow-md h-full flex flex-col">
                ...
                <div className="px-14 py-10">
                  ...
                  <p className="text-gray-600 leading-relaxed text-sm">
                    Building relationships and forging partnerships is essential
                    for growth in the mining sector. Service providers and
                    equipment companies can engage in networking, identify
                    potential clients and projects, and explore collaborations
                    with mining companies, investors, and other industry
                    stakeholders.
                  </p>
                </div>
              </div>
            ...
            <div className="w-full md:w-1/2 px-4 mb-8">
              <div className="bg-[#f8faf7] rounded-lg shadow-md h-full flex flex-col">
                ...
                <div className="px-14 py-10">
                  ...
                  <p className="text-gray-600 leading-relaxed text-sm">
                    Showcase your products, technologies, and expertise to a
                    highly targeted audience. From the latest innovations in
                    mining equipment to software solutions and professional
                    services, Mining Indaba provides a prime opportunity to
                    demonstrate your value propositions and stand out from
                    competitors.
                  </p>
                </div>
              </div>
            ...
            <div className="w-full md:w-1/2 px-4 mb-8">
              <div className="bg-[#f8faf7] rounded-lg shadow-md h-full flex flex-col">
                ...
                <div className="px-14 py-10">
                  ...
                  <p className="text-gray-600 leading-relaxed text-sm">
                    The comprehensive conference program covers key trends,
                    challenges, and opportunities shaping the African mining
                    industry. Attending the event enables service providers and
                    professional service companies to acquire valuable market
                    insights, industry intelligence, and regulatory updates
            ...
            <div className="w-full md:w-1/2 px-4 mb-8">
              <div className="bg-[#f8faf7] rounded-lg shadow-md h-full flex flex-col">
                ...
                <div className="px-14 py-10">
                  ...
                  <p className="text-gray-600 leading-relaxed text-sm">
                    Mining Indaba serves as a platform that unites key
                    stakeholders, investors, mining companies, government
                    representatives, and industry experts from around the world.
                    For service providers and equipment companies, this presents
                    invaluable networking opportunities to connect with
                    potential clients, partners, and decision-makers in the
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-50 p-6 rounded-lg shadow-lg flex flex-col items-center text-center">
            ...
            <p className="italic text-gray-700 mb-4">
              "Anybody who is anybody in Mining in Africa is here. The show this
              year is really good, it's been really well organised, that created
              a very positive vibe, it's worked really well, compliments to you
              guys."
            </p>
          ...
          <div className="bg-gray-50 p-6 rounded-lg shadow-lg flex flex-col items-center text-center">
            ...
            <p className="italic text-gray-700 mb-4">
              ...
              industry in one spot. It's a good opportunity to showcase what we
              do and network with our clients and possible future clients.
              Having a presence is important because these are our cilents and
              if they are familiar with our brand then they reach out when they
              have projects to get off the ground."
            </p>
