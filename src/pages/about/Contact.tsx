...
const Contact = () => {
  return (
    <div>
      {/* Hero Section */}
      <div
        className="h-60 flex items-center justify-center text-white text-4xl font-bold"
        style={{
      ...
      <div className="py-12">
        <div className="container mx-auto px-4">
          <h2 className="text-center text-2xl text-gray-800 mb-8">
            <i>
              Want to contact us directly? Choose how you want to get in touch
              with us here. (All fields are compulsory)
            </i>
          </h2>
              ...
              <form>
                <div className="mb-4">
                  ...
                  <input
                    type="text"
                    id="firstName"
                    className="bg-white border-1 border-black hover:border-2 hover:border-gray-400 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  />
                </div>
                <div className="mb-4">
                  <label
                ...
                <div className="mb-4">
                  ...
                  <div className="flex">
                    ...
                    <input
                      type="text"
                      id="phoneNumber"
                      className="bg-white border-1 border-black hover:border-2 hover:border-gray-400 shadow appearance-none border rounded-r w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    />
                  </div>
                </div>
                <div className="mb-4">
                ...
                <div className="mb-4 text-sm text-gray-600">
                  Hyve Group takes your privacy seriously - you can read more
                  about this in our{" "}
                  ...
                  legitimate business purposes. This includes sending you
                  marketing communications and advertising about our events as
                  well as information and publications which we think would be
                  of interest to you. You have the right to object to this
                  processing and, if you wish to do so, you can{" "}
                  <a href="#" className="text-blue-600 hover:underline">
                ...
                <button
                  type="submit"
                  className="bg-green-700 text-white font-bold py-2 px-4 rounded hover:bg-green-800 transition duration-300"
                >
                  SUBMIT
                </button>
              </form>
            ...
            <div className="w-full md:w-1/2 px-4 mb-8">
              ...
              <div>
                <h2 className="text-3xl font-bold text-gray-800 mb-4">
                  Mining Indaba Assistant – the fastest solution to your queries
                </h2>
                <p className="text-gray-600 leading-relaxed mb-4">
                  Mining Indaba Assistant is an AI-empowered FAQ system which
                  has answers to the majority of the questions you might have
                  about the event!
                </p>
                <p className="text-gray-600 leading-relaxed mb-4">
                  To start a conversation with Mining Indaba Assistant just
                  click on the icon with the speech bubble in the right corner
                  with the text 'Find all the answers on the event here!'.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  This is the fastest way to get in contact with us, so we do
                  suggest that you chat with Mining Indaba Assistant if you need
                  help. If you would still like to speak to a member of our
                  Registration team, please fill in the enquiry form above.
                  Please note that it may take up to 3 working days to respond
                  to your enquiry due to the high volume of requests that we
                  receive from many different events.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="py-12 bg-gray-100">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Need some help? Find your agent!
          </p>
          ...
          <div className="flex justify-center space-x-4 mb-8">
            <input
              ...
              className="bg-white border-1 border-black hover:border-2 hover:border-gray-400 shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            />
