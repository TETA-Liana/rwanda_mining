...
const teamMembers: TeamMember[] = Array.from({ length: 44 }).map(
  (_, index) => ({
    id: index + 1,
    ...
    description: Array.from({ length: 2 })
      .map(() => descriptions[Math.floor(Math.random() * descriptions.length)])
      .join(" "),
  ...
  return (
    <section className="py-16 bg-white">
      <div className="container">
        <h2 className="text-4xl font-bold mb-8 text-gray text-center">
        ...
        <div className="flex justify-center mt-8">
          <button className="bg-[#5cb030] hover:bg-[#55952c] text-white font-bold px-6 py-2 rounded text-sm shadow-md uppercase tracking-wide transition-colors">
