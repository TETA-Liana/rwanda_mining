...
const attendeeData: AttendeeSlide[] = [
  {
    ...
    description: 'Mining companies can benefit significantly from attending, as they will gain valuable insights into market trends, new technologies, and regulatory changes affecting the mining sector and connections to help propel their businesses forward.',
  ...
  },
  {
    ...
    description: 'Mining Indaba provides a unique platform to establish your presence in the African mining market and expand your business opportunities. Click below to find out more.',
  ...
  },
  {
    ...
    title: 'Investors',
    description: 'With our focus on fostering dialogue and highlighting projects that meet specific criteria, we strive to connect investors with opportunities that best suit their goals and objectives. Join us as we bring together industry leaders and experts to explore potential ventures in the mining sector.',
  ...
  },
  {
    ...
    description: 'Mining Indaba supports downstream buyers understand Africa\'s critical minerals wealth potential while navigating geopolitical and regulatory risks and infrastructure limitations.',
  ...
  return (
    <section className="py-16 bg-white">
      <div className="container">
        <h2 className="text-4xl font-bold text-center text-gray-800 mb-12">Who Attends?</h2>
          ...
          <div className="flex flex-col md:flex-row items-center overflow-hidden w-full">
             ...
             <div className="w-full md:w-1/2 p-8 flex flex-col justify-between items-center text-center">
                <div>
                   ...
                   <button className="bg-[#5cb030] hover:[#55952c] text-white text-sm px-2 py-2 rounded-sm font-semibold uppercase tracking-wide self-center mb-4">
