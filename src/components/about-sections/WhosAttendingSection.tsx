    ...
    <div className="container mx-auto py-12 px-4">
      <div className="bg-white p-8 rounded-lg shadow-xl text-center max-w-6xl mx-auto">
        ...
        <p className="text-gray-700 mb-6">
          Discover the caliber of attendees at Mining Indaba! Join industry
          leaders, top executives, and representatives from over 115 countries.
          Connect with influential figures shaping the future of mining and
          explore unparalleled networking opportunities.
        </p>
